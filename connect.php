<?php
// PDO Sample Code for MySQL (Localhost with XAMPP)
try {
    $conn = new PDO("mysql:host=localhost;dbname=saheli", "root", "");  // Username is 'root' and password is empty by default
...
if (empty($YName) || empty($YNumber) || empty($YEmail) || empty($YDate)) {
    ...
    $sql = "INSERT INTO appointment (YName, YNumber, YEmail, YDate) VALUES (?, ?, ?, ?)";

    // Prepare and execute the query
    $stmt = $conn->prepare($sql);
    $stmt->execute([$YName, $YNumber, $YEmail, $YDate]);
